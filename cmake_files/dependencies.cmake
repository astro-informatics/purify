...
if(dompi)
  ...
  message(STATUS "MPI VARIABLES ARE: C-INCLUDE ${MPI_C_INCLUDE_PATH}, CXX-INCLUDE ${MPI_CXX_INCLUDE_PATH}, C-LIB ${MPI_C_LIBRARIES} CXX-INCLUDE ${MPI_CXX_LIBRARIES}, and C ${MPI_C} CXX ${MPI_CXX}")
  set(PURIFY_MPI TRUE)
endif()
