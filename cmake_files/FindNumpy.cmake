...
function(numpy_feature_test OUTVARNAME testfilename testname)
  if (NUMPY_INCLUDES) # only if numpy found.
    ...
    try_compile(
      ${OUTVARNAME}
      ${CMAKE_BINARY_DIR}
      ${CMAKE_CURRENT_LIST_DIR}/${testfilename}
...
numpy_feature_test(PURIFY_NPY_LONG_DOUBLE test_numpy_long_double.c "Long double exists")
numpy_feature_test(PURIFY_NPY_BOOL test_numpy_ubyte.c "Bool is a separate type")
numpy_feature_test(PURIFY_NPY_ARRAY test_numpy_is_noarray.c "NPY_ARRAY_* macros exist")
set(PURIFY_NPY_ENABLE_FLAGS)
numpy_feature_test( PURIFY_NPY_ENABLEFLAGS test_numpy_has_enableflags.c
