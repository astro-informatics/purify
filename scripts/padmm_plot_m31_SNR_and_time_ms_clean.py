...
if __name__ == '__main__':
	...
	np.savetxt('padmm_ms_clean_SNRtable', tableSNR, delimiter=',')
	np.savetxt('padmm_ms_clean_Timetable', tableTime, delimiter=',')
	...
	plt.ylabel("SNR, db")
	plt.xlim(0, 2.2)
	plt.savefig("padmm_ms_clean_SNR_plot.pdf")
	plt.clf()
	...
	plt.xlim(0, 2.2)
	plt.savefig("padmm_ms_clean_Time_plot.pdf")
	plt.clf()
