...
def run_test((i, kernel, M_N_ratio, start_time)):
	...
	if kernel == "kb_interp":
  	...
  	os.system("../build/cpp/example/sdmm_clean_m31_simulation " + kernel + " " 
...
if __name__ == '__main__':
	...
	np.savetxt('sdmm_clean_SNRtable', tableSNR, delimiter=',')
	np.savetxt('sdmm_clean_Timetable', tableTime, delimiter=',')
	...
	plt.ylabel("SNR, db")
	plt.xlim(0, 2.2)
	plt.savefig("sdmm_clean_SNR_plot.pdf")
	plt.clf()
	...
	plt.xlim(0, 2.2)
	plt.savefig("sdmm_clean_Time_plot.pdf")
	plt.clf()
