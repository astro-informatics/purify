function pswf = purify_mtlb_opt_PSWF(x, J, alpha)
...
if (J == 6 && alpha == 1) %the value of support and alpha that is standard in radio astronomy software, e.g. AIPS (VLA) and MIRIAD (ATCA).
