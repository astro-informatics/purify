...
public:
  ...
  std::array<void *, 6> forward_data() const {
    return {(void *)&params,      (void *)deconv.data(),      (void *)&gmat,
            (void *)&fft_forward, (void *)fft_forward.data(), (void *)shifts.data()};
  }
  //! State array to pass on to C function
  std::array<void *, 6> inverse_data() const {
    return {(void *)&params,      (void *)deconv.data(),      (void *)&gmat,
            (void *)&fft_inverse, (void *)fft_inverse.data(), (void *)shifts.data()};
  }
  ...
  sopt::LinearTransform<Vector<t_complex>> linear_transform() const {
    ...
    std::array<int, 3> const direct_size{0, 0, static_cast<int>(visibilities.vis.size())};
    ...
    std::array<int, 3> const adjoint_size{0, 0, static_cast<int>(fft_forward.size())};
