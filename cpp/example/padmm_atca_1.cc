...
int main(int, char **) {
  ...
  std::string const visfile = atca_filename("0114-476.vis");
  std::string const outfile_fits = output_filename("atca_solution_1.fits");

  std::string const dirty_image_fits = output_filename("atca_dirty_1.fits");

  std::string const residual_fits = output_filename("atca_residual_1.fits");
