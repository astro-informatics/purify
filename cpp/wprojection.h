...
namespace purify {
 ...
 namespace wprojection {
     ...
     //! Generates chirp matrix
      Matrix<t_complex> create_chirp_matrix(const Vector<t_real> & w_components, const t_real cell_x, const t_real cell_y, const t_int &ftsizeu, const t_int &ftsizev, const t_real& energy_fraction = 1);
 }
}
