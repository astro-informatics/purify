...
BENCHMARK_REGISTER_F(PadmmFixtureMPI, ApplyAlgo1)
    ...
    ->Args({1024, static_cast<t_int>(5e8), 4, 100, 1})
    ->Args({1024, static_cast<t_int>(1e7), 4, 100, 1})
    ->Args({1024, static_cast<t_int>(5e7), 4, 100, 1})
    ->Args({1024, static_cast<t_int>(1e8), 4, 100, 1})
    //->Args({128, 1000, 4})
    ->UseManualTime()
...
BENCHMARK_REGISTER_F(PadmmFixtureMPI, ApplyAlgo3)
    //->Apply(b_utilities::Arguments)
    ->Args({1024, static_cast<t_int>(1e6), 4, 100, 3})
    ->Args({1024, static_cast<t_int>(5e8), 4, 100, 3})
    ->Args({1024, static_cast<t_int>(1e7), 4, 100, 3})
    ->Args({1024, static_cast<t_int>(5e7), 4, 100, 3})
    ->Args({1024, static_cast<t_int>(1e8), 4, 100, 3})
    //->Args({128, 1000, 4})
    ->UseManualTime()
    ->Repetitions(1)  //->ReportAggregatesOnly(true)
    ->Unit(benchmark::kMillisecond);
