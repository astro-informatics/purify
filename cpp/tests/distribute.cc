...
TEST_CASE("Distribute"){
  ...
  std::vector<t_int> groups_equal =
    distribute::distribute_measurements(
        uv_data.u.segment(0, number_of_vis),
        uv_data.v.segment(0, number_of_vis),
        uv_data.w.segment(0, number_of_vis),
        number_of_groups, "equal_distribution", 1024);
  ...
  std::vector<t_int> groups_distance =
    distribute::distribute_measurements(
        uv_data.u.segment(0, number_of_vis),
        uv_data.v.segment(0, number_of_vis),
        uv_data.w.segment(0, number_of_vis),
        number_of_groups, "distance_distribution");
  //Testing number of visiblities in groups adds to total
  ...
  std::vector<t_int> groups_noorder =
    distribute::distribute_measurements(
        uv_data.u.segment(0, number_of_vis),
        uv_data.v.segment(0, number_of_vis),
        uv_data.w.segment(0, number_of_vis),
